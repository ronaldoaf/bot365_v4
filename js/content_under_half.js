   ...
   $('.ipe-ParticipantCouponFixtureName_Participant').each(function(i,e){
	   ...
	   $(jogos).each(function(ii,jogo){			   
			 ...
			 if(  (ns(jogo.home)==ns(home)) && (ns(jogo.away)==ns(away)) ){
				   ...
				   plU_por_odds=(d_g==0)&&(goal_diff>=1.5) ? 6*(-0.00631096102*s_g + -0.00698648754*s_c + -0.00023684517*s_da + -0.00715815396*s_s + -5.81849414e-05*d_da + -0.0016536692*d_s + 0.110846748*goal_diff + 0.18661998*oddsU + -0.393345962) : -1;
